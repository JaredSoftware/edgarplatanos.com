<template>
  <div>
    ...
    <div v-for="(object, index) in info" v-bind:key="index">
      <NuxtLink :to="'/viaje' + '?id=' + object.id + linkForredirect" class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
          <h5
